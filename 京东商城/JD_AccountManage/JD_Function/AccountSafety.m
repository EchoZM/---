...
-(void)ConfirmButton:(UIBarButtonItem *)sender{
    ...
    [[JD_DataManager shareGoodsDataManager] downloadDataWithHTTPMethod:@"post" WithBodyString:lBodyString WithURLString:@"changepassword.php" AndSuccess:^(NSData *data) {
