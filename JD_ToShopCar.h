...
@interface JD_ToShopCar : UIViewController<UITableViewDataSource,UITableViewDelegate,ASIHTTPRequestDelegate,NSURLConnectionDataDelegate,UITextFieldDelegate>{
